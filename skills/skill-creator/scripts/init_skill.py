...
SKILL_TEMPLATE = """---
name: {skill_name}
description: [TODO: 完整且信息丰富地解释技能做什么以及何时使用它。包括何时使用此技能 - 触发它的特定场景、文件类型或任务。]
---
...
**注意：** 脚本可以在不加载到上下文中的情况下执行，但仍可能需要被 Claude 读取以进行修补或环境调整。

### references/
旨在根据需要加载到上下文中以指导 Claude 的过程和思考的文档和参考材料。
